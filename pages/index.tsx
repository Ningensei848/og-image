...
const DynamicComponentWithNoSSR = dynamic(() => import('components/OGImage'), {
  ssr: false
})
...
const OGImage = (): JSX.Element => (
  <div className='container'>
    <div className='wrapper'>
      <a href='https://github.com/vercel/og-image' className='github-corner' aria-label='View source on GitHub'>
      ...
      <div className='center'>
        ...
        <p>
          For each keystroke, headless chromium is used to render an HTML page and take a screenshot of the result which
          gets cached.
        </p>
        <p>
